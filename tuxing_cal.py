    ...
    while True:
        if huida == "长方体":
            ...
            if huida1 == "体积":
                ...
                huida4 = int(huida4)
                if huida4 == 1:
                    return("4个面染色的小正方体有4个。")
                    return("3个面染色的小正方体有" + str((huida2 - 2) * 2 + (huida3 - 2) * 2) + "个。")
                    return("2个面染色的小正方体有" + str((huida2 - 2) * (huida3 - 2)) + "个。")
                else:
                    return("3个面染色的小正方体有8个。")
                    return("2个面染色的小正方体有" + str(((huida2-2)+(huida3-2)+(huida4-2))*4) +"个。")
                    return("1个面染色的小正方体有" + str(((huida2-2)*(huida3-2)+(huida2-2)*(huida4-2)+(huida3-2)*(huida4-2))*2) + "个。")
                    return("0个面染色的小正方体有" + str((huida2-2)*(huida3-2)*(huida4-2)) + "个")
            elif huida1 == "棱长总和":
            ...
            if huida1 == "体积":
                ...
                if huida2 == 1:
                    ...
                    return("3个面染色的小正方体有8个。")
                    return("2个面染色的小正方体有" + str((huida2-2)*12) + "个。")
                    return("1个面染色的小正方体有" + str((huida2-2)**2*6) + "个。")
                    return("0个面染色的小正方体有" + str((huida2-2)**3) + "个。")
            else:
                return 1
        elif huida == "正方形":
